...
async function sendMessage() {
    ...
    botMessage.textContent = 'Mental Health Bot: ';
    ...
    try {
        ...
        while (true) {
            ...
            // Decode the chunk and log it to the console
            const chunk = decoder.decode(value);
            console.log("Received chunk:", chunk); // Log the chunk for debugging

            // Append the chunk to the bot's message with a space
        ...
        botMessage.textContent = `Mental Health Bot: Sorry, I am unable to process your request at the moment. (Error: ${error.message})`;
    }
